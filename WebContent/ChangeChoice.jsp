...
<tr><th>Professor Name</th><th>Class Topic</th><th>Date & Time</th><th>Material Name</th></tr>
<%
try{
	...
	String pname = request.getParameter("t1");
			...
			ResultSet rs = stmt.executeQuery("select * from updateclass where professor ='"+user+"'");
			while(rs.next()){%>
