...
<tr><th>Student Name</th><th>Subject/Course Details</th><th>Comments</th><th>Status</th></tr>
<%
try{
	...
	String pname = request.getParameter("t1");
			...
			ResultSet rs = stmt.executeQuery("select username,class_topic,comments,approve_status from registerclass where username='"+user+"'");
			while(rs.next()){%>
