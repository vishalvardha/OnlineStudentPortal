...
<th>Username</th><th>Password</th><th>Approved</th></tr>
<%
try{
	String pname = request.getParameter("t1");
			  Connection con = DBCon.getCon();
			  Statement stmt = con.createStatement();
			ResultSet rs = stmt.executeQuery("select * from register where access='Not Approved'");
			while(rs.next()){%>
			...
			<td><a href="StudentApproved?t1=<%=rs.getString(1)%>">Click Here</a></td>
		  <%}}catch(Exception e){
			  e.printStackTrace();
		  }%>
		  </table>
